...
val idToSpell = JSONObject("""
        {"21":{"id":"SummonerBarrier","name":"光盾"},"1":{"id":"SummonerBoost","name":"淨化"},"14":{"id":"SummonerDot","name":"點燃"},"3":{"id":"SummonerExhaust","name":"虛弱"},"4":{"id":"SummonerFlash","name":"閃現"},"6":{"id":"SummonerHaste","name":"鬼步"},"7":{"id":"SummonerHeal","name":"治癒"},"13":{"id":"SummonerMana","name":"清晰"},"30":{"id":"SummonerPoroRecall","name":"為了吾王！"},"31":{"id":"SummonerPoroThrow","name":"普羅投擲"},"11":{"id":"SummonerSmite","name":"重擊"},"39":{"id":"SummonerSnowURFSnowball_Mark","name":"標記"},"32":{"id":"SummonerSnowball","name":"標記"},"12":{"id":"SummonerTeleport","name":"傳送"}}""")
...
///////////////////////////////////////////////
                ...
                val p1_spell_1 = resources.getIdentifier(
                    JSONObject(idToSpell[p1_spell_1_img].toString())["id"].toString().toLowerCase(),
                    "drawable",
                    packageName
                )
                ...
                val p1_spell_2 = resources.getIdentifier(
                    JSONObject(idToSpell[p1_spell_2_img].toString())["id"].toString().toLowerCase(),
                    "drawable",
                    packageName
                )
                ...
                val p2_spell_1 = resources.getIdentifier(
                    JSONObject(idToSpell[p2_spell_1_img].toString())["id"].toString().toLowerCase(),
                    "drawable",
                    packageName
                )
                ...
                val p2_spell_2 = resources.getIdentifier(
                    JSONObject(idToSpell[p2_spell_2_img].toString())["id"].toString().toLowerCase(),
                    "drawable",
                    packageName
                )
                ...
                val p3_spell_1 = resources.getIdentifier(
                    JSONObject(idToSpell[p3_spell_1_img].toString())["id"].toString().toLowerCase(),
                    "drawable",
                    packageName
                )
                ...
                val p3_spell_2 = resources.getIdentifier(
                    JSONObject(idToSpell[p3_spell_2_img].toString())["id"].toString().toLowerCase(),
                    "drawable",
                    packageName
                )
                ...
                val p4_spell_1 = resources.getIdentifier(
                    JSONObject(idToSpell[p4_spell_1_img].toString())["id"].toString().toLowerCase(),
                    "drawable",
                    packageName
                )
                ...
                val p4_spell_2 = resources.getIdentifier(
                    JSONObject(idToSpell[p4_spell_2_img].toString())["id"].toString().toLowerCase(),
                    "drawable",
                    packageName
                )
                ...
                val p5_spell_1 = resources.getIdentifier(
                    JSONObject(idToSpell[p5_spell_1_img].toString())["id"].toString().toLowerCase(),
                    "drawable",
                    packageName
                )
                ...
                val p5_spell_2 = resources.getIdentifier(
                    JSONObject(idToSpell[p5_spell_2_img].toString())["id"].toString().toLowerCase(),
                    "drawable",
                    packageName
                )
                ...
                val p6_spell_1 = resources.getIdentifier(
                    JSONObject(idToSpell[p6_spell_1_img].toString())["id"].toString().toLowerCase(),
                    "drawable",
                    packageName
                )
                ...
                val p6_spell_2 = resources.getIdentifier(
                    JSONObject(idToSpell[p6_spell_2_img].toString())["id"].toString().toLowerCase(),
                    "drawable",
                    packageName
                )
                ...
                val p7_spell_1 = resources.getIdentifier(
                    JSONObject(idToSpell[p7_spell_1_img].toString())["id"].toString().toLowerCase(),
                    "drawable",
                    packageName
                )
                ...
                val p7_spell_2 = resources.getIdentifier(
                    JSONObject(idToSpell[p7_spell_2_img].toString())["id"].toString().toLowerCase(),
                    "drawable",
                    packageName
                )
                ...
                val p8_spell_1 = resources.getIdentifier(
                    JSONObject(idToSpell[p8_spell_1_img].toString())["id"].toString().toLowerCase(),
                    "drawable",
                    packageName
                )
                ...
                val p8_spell_2 = resources.getIdentifier(
                    JSONObject(idToSpell[p8_spell_2_img].toString())["id"].toString().toLowerCase(),
                    "drawable",
                    packageName
                )
                ...
                val p9_spell_1 = resources.getIdentifier(
                    JSONObject(idToSpell[p9_spell_1_img].toString())["id"].toString().toLowerCase(),
                    "drawable",
                    packageName
                )
                ...
                val p9_spell_2 = resources.getIdentifier(
                    JSONObject(idToSpell[p9_spell_2_img].toString())["id"].toString().toLowerCase(),
                    "drawable",
                    packageName
                )
                ...
                val p10_spell_1 = resources.getIdentifier(
                    JSONObject(idToSpell[p10_spell_1_img].toString())["id"].toString().toLowerCase(),
                    "drawable",
                    packageName
                )
                ...
                val p10_spell_2 = resources.getIdentifier(
                    JSONObject(idToSpell[p10_spell_2_img].toString())["id"].toString().toLowerCase(),
                    "drawable",
                    packageName
                )
