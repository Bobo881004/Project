...
val idToMap = JSONObject("""
        {"11":"召喚峽谷","8":"水晶之痕","10":"扭曲叢林","12":"咆嘯深淵"}
    """)
...
class CustomAdapter(val context: Context, val champion:ArrayList<ListView_save>):BaseAdapter() {
    ...
    private class ViewHolder(row:View?){
        val txtName : TextView = row?.findViewById(R.id.championName) as TextView
        val ivImage : ImageView = row?.findViewById(R.id.championPic) as ImageView
        val txtMatchend : TextView = row?.findViewById(R.id.matchEnd_id) as TextView
        val txtScore : TextView = row?.findViewById(R.id.Scroe_id) as TextView
        val txtCs : TextView = row?.findViewById(R.id.cs_id) as TextView
        val txtMoney : TextView = row?.findViewById(R.id.money_id) as TextView
        val txtDate : TextView = row?.findViewById(R.id.date_id) as TextView
        val txtTime : TextView = row?.findViewById(R.id.time_id) as TextView
        val txtMap : TextView = row?.findViewById(R.id.gameMap_id) as TextView
    }
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        viewHolder.txtMap.text = idToMap[info.gameMap].toString()
